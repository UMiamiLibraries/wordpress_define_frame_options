...
class Uml_Define_Frame_Options {
	...
	private function define_admin_hooks() {
        ...
        $this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'uml_set_frame_options_header' );

        $this->loader->add_action( 'admin_menu', $plugin_admin, 'show_in_admin_menu' );
        $this->loader->add_action( 'wp_enqueue_scripts', $plugin_admin, 'uml_set_frame_options_header' );
